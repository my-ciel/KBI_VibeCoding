...
function displayResults() {
    ...
    let highScore = parseInt(savedHighScore);

    if (finalScore > highScore) {
        highScore = finalScore;
        localStorage.setItem('quizHighScore', highScore);
        // 새로운 최고 점수 알림 (선택 사항)
        document.getElementById('resultScreen').querySelector('.result-title').textContent = '🎊 새로운 최고 점수! 🎊';
    } else {
        document.getElementById('resultScreen').querySelector('.result-title').textContent = '🏆 퀴즈 완료!';
    }
